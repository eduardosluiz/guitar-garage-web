// src/app/servicos/lutheria/LutheriaClient.tsx
"use client";
            ...
            <div className={styles.imageSide}>
              ...
              <div className={styles.manifestoBlock}>
                ...
                <div className={styles.manifestoItem}>
                  ...
                  <p>
                    <strong>Poliuretano é um material proibido</strong> em nossa cabine de pintura, só trabalhamos com nitrocelulose, seja como fundo, cor ou verniz.
                  </p>
                </div>
                <div className={styles.manifestoItem}>
                ...
                <div className={styles.manifestoFooter}>
                  <p>Abaixo alguns exemplos do que temos feito em termos de restauração ao longo de 20 anos de Guitar Garage.</p>
